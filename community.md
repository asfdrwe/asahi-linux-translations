...
作業文書は[GitHub](https://github.com/AsahiLinux/docs)を元に[MKDocs](https://www.mkdocs.org/)(訳注:[zensical](https://zensical.org/)に移行しています)を使用して[文書サイト](https://asahilinux.org/docs/)で管理されています。
