...
作業文書は[GitHub](https://github.com/AsahiLinux/docs)を元に[MKDocs](https://mkdocs.org/)(訳注:[zensical](https://zensical.org/)に移行しています)を使用して[文書サイｔ](https://asahilinux.org/docs/)で管理されています。
