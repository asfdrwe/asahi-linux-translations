...
もしインストールすると決めたなら、詳細なバグレポートを提出したり問題のデバッグを手伝うことで、私たちを助けてくれるることを望んでいます。
...
### これをインストールするにはAppleにphoning home(訳注:おそらく[この意味](https://en.wikipedia.org/wiki/Phoning_home)、Appleのサーバと通信すること)する必要があるのでしょうか？
