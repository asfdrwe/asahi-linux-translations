...
訳注: 文書wikiへのリンクは対応する日本語訳へのリンクに置き換え

FAQの最初までチェックで残りはDeepLのまま
...
- Wi-Fi
- USB2 (Thunderboltポート)https://github.com/sponsors/povik
...
[Patreon](https://www.patreon.com/marcan)(訳注:原文がリンクミスしているのて正しいページへのリンクに修正)や
