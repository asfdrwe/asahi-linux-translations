...
2026/7/4時点の[faq](https://github.com/AsahiLinux/docs/blob/main/docs/project/faq.md)の翻訳
...
コマンドラインでパーティションを管理する方法は [パーティション分割のチートシート](../sw/partitioning-cheatsheet.md)  をご覧ください。

## インストーラを使ってどのシステムもインストールできません。機器がブートループには入って Recovery OS に落ちます

これはOS を何回も何回もインストールしたときに起こる Apple のバグの可能性が非常に高いです。
[この issue](https://github.com/AsahiLinux/asahi-installer/issues/255#issuecomment-1987050522) を参照してください。
