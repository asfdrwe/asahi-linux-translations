---
title: USB-PD デバッグインターフェイス
---

2025/3/9時点の[usb-debug](https://github.com/AsahiLinux/docs/blob/main/docs/hw/soc/usb-debug.md)の翻訳

---
これは内蔵デバッグ用のUSBインターフェイスのようです。

EP 0x01によるコマンド、0x81、0x82による応答は不明です。

ランダムなものを送ろうとしているREメモ:
