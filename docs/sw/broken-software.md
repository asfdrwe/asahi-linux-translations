...
2026/4/19時点の[broken-software](https://github.com/AsahiLinux/docs/blob/main/docs/sw/broken-software.md)の翻訳
...
ために改善することが確認できます！ [修正済みパッケージ](#_3) をご覧ください。この結果としてすべての
...
| jemalloc | <https://github.com/jemalloc/jemalloc/pull/2864> | 5.3.1 以降で修正 |
...
| kdeconnect       | [PipeWire 使用時に KDE Connect Bluetooth backend が Bluetooth ヘッドセット (A2DP)にクリックノイズ(crackling)や音飛び(stuttering)を引き起こす](https://bugs.kde.org/show_bug.cgi?id=513536) |
...
| pipewire         | [pipewiresrc: Asahi Linux でハング](https://gitlab.freedesktop.org/pipewire/pipewire/-/issues/4957) | pipewire 1.4.10 で修正|
