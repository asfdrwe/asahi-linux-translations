...
2026/3/18時点の[partitioning-cheatsheet](https://github.com/AsahiLinux/docs/blob/main/docs/sw/partitioning-cheatsheet.md)の翻訳
...
インストーラは(通常の Fedora Asahi Remix インストールの場合)3つのパーティションを作成します:
