...
示すものです。まず、[Apple Siliconの紹介](introduction.md) を読み、Apple の観点からこのプラットフォームがどのように設計されているかを
学ぶことをお勧めします。
...
リファレンス Linux システムの典型的なブートは、[ブートフロー](introduction.md#_5)セクションの続きで、次のようになります。
...
注意: この文書の [古いバージョン](open-os-interop-old.md) では、rootファイルシステム上のファームウェアの
