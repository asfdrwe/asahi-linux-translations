...
2026/8/3時点の[m1](https://github.com/AsahiLinux/docs/blob/main/docs/playtform/feature-support/m1.md)の翻訳
...
- [SoCブロック](#soc)
- [M1機器](#m1)
- [M1 Pro/Max/Ultra機器](#m1-promaxultra)
- [注釈](#_2)
...
| Video Decoder    | linux-asahi    　    | linux-asahi              |
| NVMe             | 5.19                 | 5.19                     |
| PCIe             | 5.16                 | 5.16                     |
| PCIe (GE)        | -                    | -                        |
| cpufreq          | 6.2                  | 6.2                      |
| cpuidle          | linux-asahi([注釈](#cpuidle)) | linux-asahi([注釈](#cpuidle)) |
...
| RTC              | 7.0                  | 7.0                      |
| SEP              | 作業中               | 作業中                   |
| Neural Engine    | ツリー外([注釈](#ane)) | [注釈](#ane)           |
...
| スピーカー         | linux-asahi ([注釈](#_3)) | linux-asahi ([注釈](#_3)) | linux-asahi ([注釈](#_3)) | 未対応|
| SDカードスロット   | -                    | -                              | -                     | -                    |
...
| スピーカー         |linux-asahi ([注釈](#_3))  | linux-asahi ([注釈](#_3)) |
| SDカードスロット   | 5.17                              | 5.17                 |
| 1Gbps Ethernet     | -                                 | -                    |
| 10Gbps Ethernet    | -                                 | 6.2                  |
| マイク             | linux-asashi                      | -                    |
