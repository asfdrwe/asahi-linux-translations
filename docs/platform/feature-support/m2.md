...
2026/4/22時点の[m2](https://github.com/AsahiLinux/docs/blob/main/docs/platform/feature-support/m2.md)の翻訳
...
- [SoCブロック](#soc)
- [M2 機器](#m2)
- [M2 Pro/Max/Ultra機器](#m2-promaxultra)
- [注釈](#_2)
...
| USB2 (TB ports)  | 7.0                  | 7.0                         |
| USB3 (TB ports)  | 7.0                  | 7.0                         |
| Thunderbolt      | 作業中               | 作業中                      |
| DP Alt Mode      | 作業中               | 作業中                      |
| GPU              | linux-asahi          | linux-asahi                 |
| Video Decoder    | 未着手               | 未着手                      | 
| NVMe             | 5.19                 | 5.19                        |
| PCIe             | 5.16 / 6.4 (dts)     | 6.16                        |
| PCIe (GE)        | -                    | 未着手                      |
| cpufreq          | 6.2                  | 6.2                         |
| cpuidle          | linux-asahi([注釈参照](#cpuidle)) | linux-asahi([注釈参照](#cpuidle)) |
...
| RTC              | 7.0                  | 6.15                        |
| SEP              | 作業中               | 作業中                      |
| Neural Engine    | ツリー外([注釈参照](#ane)) | [注釈参照](#ane) |
...
| 輝度調整           | -                  | linux-asahi                       | -                    | -                    |
| バッテリー情報     | -                  | linux-asahi                       | -                    | -                    |
| WiFi               | linux-asahi        | 6.18                              | 6.18                 | linux-asahi          |
...
| 10Gbps Ethernet    | linux-asahi        | -                                 | 6.18                 | linux-asahi          |
| Touch Bar          | -                  | -                                 | -                    | -                    |
| TouchID            | -                  | 未着手                            |　未着手              | 未着手               |
...
`appledrm`カーネルモジュールの`hdmi_audio`パラメータを有効にすることで試すことができます。
