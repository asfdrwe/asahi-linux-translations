...
結合することしかできません(訳注: ほとんど使われていませんが 32bit x86 でも Pentium から追加された[Page Size Extension(PSE)](https://en.wikipedia.org/wiki/Physical_Address_Extension)で 4MB ページに対応し、Pentium Pro から追加された[Physical Address Extension(PAE)]でも 2MB ページに対応しています。Linux 
